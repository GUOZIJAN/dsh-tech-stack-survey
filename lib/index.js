...
// ----------------------------------------------------------------------------
// Static Cordis plugin twin of the dynamic `host.js` sandbox body. Where the
// dynamic body uses the sandbox globals `harness.defineTool` /
// `harness.registerTool(ctx, tool)`, this module imports the real
...
// (e.g. @deepseek-ai/dsh-tool-ask-user).
//
